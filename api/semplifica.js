...
const SYSTEM = `Ricevi due schede di studio gia pronte (in JSON) per una ragazza di SECONDA LICEO SCIENTIFICO con un lieve DSA. Materie principali: MATEMATICA e FISICA.

${VOCE}

Il tuo compito: RISCRIVERLE PIU SEMPLICI di come sono adesso, senza perdere i concetti importanti ne la correttezza.
- La scheda "studio" deve restare una LEZIONE DA ZERO e progressiva (NON trasformarla in un riassunto): rendila solo ancora piu facile, con passi piu piccoli e parole piu comuni.
