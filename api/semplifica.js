...
- Se trovi blocchi di tipo "immagine", "schema" o "immagine_web", riportali IDENTICI dove sono, senza modificarli (non toccare i campi "src", "svg", "query", "box", "attribution").
